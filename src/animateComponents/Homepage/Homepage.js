...
const Homepage = () => {
    return (
        <motion.div className="homeDiv" exit={{ opacity: 0, transition: "easeInOut" }} transition={{ duration: 1 }}>
            <div className="left">
                    ...
                    <div className="social-container">
                        <div className="social">
                            <a href="https://github.com/blackenjoy27?tab=repositories">
                                <svg className="git" aria-hidden="true"
                        ...
                        <div className="social">
                            <a href="https://www.linkedin.com/in/xunxin-li-525a3220a/">
                        ...
                        <div className="social">
                            <form action="mailTo: xiaohaha237@gmail.com" id="form">
                                <a href="#" onClick={(e) => { e.preventDefault(); document.getElementById('form').submit(); }}>
                                    <svg aria-hidden="true" focusable="false" type="button"
